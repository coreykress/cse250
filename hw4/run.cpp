...
int main(){
  ...
  game_board.push_back(new Square(18,12));
  game_board.push_back(new Square(12,7));
  game_board.push_back(new Square(18,12));
 ...
 // std::cout<< "this is the a location in the path " << path[0]<<std::endl;
  //std::cout<< "this is the a location in the path " << path[1]<<std::endl;
  //std::cout<< "this is the a location in the path " << path[2]<<std::endl;
  //std::cout<< "this is the a location in the path " << path[3]<<std::endl;
